...
- [x] US-012 — Add CI grep gate enforcing no Shopify keys in generic surfaces
...
- [x] US-019 — Write hypothetical barbershop walkthrough doc as architecture validation
