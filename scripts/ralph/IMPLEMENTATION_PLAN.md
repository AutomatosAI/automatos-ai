...
- [ ] US-001: Create decomposition template library (templates.py)
- [ ] US-002: Wire template matching into MissionPlanner
- [ ] US-003: Wire history-based agent scoring in AgentMatcher
