  ...
  constructor() {
    ...
    private initializeMockData(): Record<string, () => any> {
      ...
      '/api/context/performance': () => ({
        ...
        memory_usage: 456,
        performance_data: [
          { time: '00:00', speed: 120, accuracy: 0.95 },
          { time: '04:00', speed: 135, accuracy: 0.92 },
          { time: '08:00', speed: 145, accuracy: 0.89 },
          { time: '12:00', speed: 165, accuracy: 0.87 },
          { time: '16:00', speed: 155, accuracy: 0.90 },
          { time: '20:00', speed: 140, accuracy: 0.93 }
        ]
      }),

      '/api/context/sources': () => [
        { id: 1, name: 'Knowledge Base', type: 'vector', status: 'active', documents: 245 },
        { id: 2, name: 'Document Store', type: 'text', status: 'active', documents: 156 },
        { id: 3, name: 'Code Repository', type: 'code', status: 'active', documents: 89 },
        { id: 4, name: 'API Documentation', type: 'structured', status: 'active', documents: 67 }
      ],
      ...
      '/api/context/queries/recent': () => [
        {
          ...
          confidence: 0.92,
          sources: ['Knowledge Base', 'API Documentation']
        },
        {
          id: 2,
          query: 'What are the performance optimization strategies?',
          timestamp: new Date(Date.now() - 600000).toISOString(),
          confidence: 0.87,
          sources: ['Document Store', 'Code Repository']
        },
        {
          id: 3,
          query: 'Explain the workflow execution process',
      ...
      '/api/context/patterns': () => [
        {
          ...
          frequency: 0.35,
          avg_confidence: 0.91,
          common_sources: ['Knowledge Base', 'API Documentation'],
          optimization_suggestions: ['Cache authentication docs', 'Pre-index common patterns']
        },
        {
          id: 2,
          ...
          frequency: 0.28,
          avg_confidence: 0.87,
          common_sources: ['Document Store', 'Code Repository'],
          optimization_suggestions: ['Create performance FAQ', 'Index optimization guides']
        },
        {
          id: 3,
          ...
          frequency: 0.22,
          avg_confidence: 0.94,
          common_sources: ['Knowledge Base'],
          optimization_suggestions: ['Workflow diagram indexing', 'Process documentation']
        },
        {
          id: 4,
          name: 'Error Handling',
          frequency: 0.15,
          avg_confidence: 0.89,
          common_sources: ['Code Repository', 'Document Store'],
          optimization_suggestions: ['Error code documentation', 'Troubleshooting guides']
        }
      ],
