        ...
        <Card className="glass-card">
          <CardContent className="p-4">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="shrink-0 text-right text-xs text-info">
                Active repositories
              </div>
            </div>
          </CardContent>
        ...
        <Card className="glass-card">
          <CardContent className="p-4">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="shrink-0 text-right text-xs text-agent">
                Functions &amp; classes
              </div>
            </div>
          </CardContent>
              ...
              <Card key={project.id} className="glass-card hover:border-primary/50 transition-all">
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    <Badge variant={project.status === 'active' ? 'default' : project.status === 'indexing' ? 'outline' : 'secondary'} className={project.status === 'indexing' ? 'animate-pulse border-blue-500 text-info' : ''}>
