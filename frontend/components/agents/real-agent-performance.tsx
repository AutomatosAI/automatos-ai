...
interface RealAgentPerformanceProps {
  agents: any[]
  agentStats: any
...
export function RealAgentPerformance({ 
  agents, 
  agentStats, 
  selectedAgentId,
  onAgentSelect,
  showAnalytics = false 
}: RealAgentPerformanceProps) {
  ...
  // Performance trend data (mock - replace with real API data)
  const performanceTrend = [
    { time: '00:00', performance: 92 },
    { time: '04:00', performance: 95 },
    { time: '08:00', performance: 98 },
    { time: '12:00', performance: 94 },
    { time: '16:00', performance: 96 },
    { time: '20:00', performance: 93 },
    { time: '24:00', performance: 95 }
  ]
