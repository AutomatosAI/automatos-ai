...
import { useUpdateSkill } from '@/hooks/use-agent-api'
...
export function SkillConfigurationModal({ open, onClose, onSuccess, skill }: SkillConfigurationModalProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold flex items-center gap-2">
            ...
            Configure <span className="gradient-text">Skill</span>: {skill?.name}
          </DialogTitle>
        </DialogHeader>
