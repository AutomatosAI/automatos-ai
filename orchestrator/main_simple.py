"""
Simplified FastAPI Application for Automotas AI
==============================================

Core API server without document processing for initial testing.
"""
...
# Import API routers (excluding documents for now)
