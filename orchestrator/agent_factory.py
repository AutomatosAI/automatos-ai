...
❌ WRONG: "I would use search_knowledge to find information about X"
✅ CORRECT: Immediately output: {"action": "search_knowledge", "params": {"query": "X", "limit": 5}}""")
...
\nYou can include multiple action blocks in your response."""
            ...
            tools_prompt = self._build_tools_prompt(required_tools)
