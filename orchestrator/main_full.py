...
# Additional routers from NEW_Orchestrator
try:
    from api.problems import router as problems_router
    app.include_router(problems_router, tags=['Problems'])
    print('✅ Problems router loaded')
except Exception as e:
    print(f'⚠️ Problems router not loaded: {e}')

try:
    from api.synthesis import router as synthesis_router
    app.include_router(synthesis_router, tags=['Synthesis'])
    print('✅ Synthesis router loaded')
except Exception as e:
    print(f'⚠️ Synthesis router not loaded: {e}')

try:
    from api.knowledge import router as knowledge_router
    app.include_router(knowledge_router, tags=['Knowledge'])
    print('✅ Knowledge router loaded')
except Exception as e:
    print(f'⚠️ Knowledge router not loaded: {e}')

try:
    from api.learning import router as learning_router
    app.include_router(learning_router, tags=['Learning'])
    print('✅ Learning router loaded')
except Exception as e:
    print(f'⚠️ Learning router not loaded: {e}')

try:
    from api.orchestrator import router as orchestrator_router
    app.include_router(orchestrator_router, tags=['Orchestrator'])
    print('✅ Orchestrator router loaded')
except Exception as e:
    print(f'⚠️ Orchestrator router not loaded: {e}')

try:
    from api.insights import router as insights_router
    app.include_router(insights_router, tags=['Insights'])
    print('✅ Insights router loaded')
except Exception as e:
    print(f'⚠️ Insights router not loaded: {e}')
...
try:
    ...
    print(f'⚠️ Recommendations router not loaded: {e}')

try:
    from api.solutions import router as solutions_router
    app.include_router(solutions_router, tags=['Solutions'])
    print('✅ Solutions router loaded')
except Exception as e:
    print(f'⚠️ Solutions router not loaded: {e}')
...
try:
    ...
    print(f'⚠️ Query router not loaded: {e}')
