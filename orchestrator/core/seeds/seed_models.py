    ...
    with get_db_session() as db:
        ...
        db.execute(text("""
            INSERT INTO llm_models (
                provider, serving_provider, model_id, display_name, model_family,
            ...
            -- GPT-4 Turbo
            ('openai', 'openai', 'gpt-4-turbo-preview', 'GPT-4 Turbo', 'gpt-4',
            ...
            -- GPT-3.5 Turbo
            ('openai', 'openai', 'gpt-3.5-turbo', 'GPT-3.5 Turbo', 'gpt-3.5',
            ...
            ON CONFLICT ON CONSTRAINT uq_llm_models_provider_model DO NOTHING
        """))
        ...
        db.execute(text("""
            ...
            -- Claude 3 Opus
            ('anthropic', 'anthropic', 'claude-3-opus-20240229', 'Claude 3 Opus', 'claude-3',
            ...
            -- Claude 3 Sonnet
            ('anthropic', 'anthropic', 'claude-3-sonnet-20240229', 'Claude 3 Sonnet', 'claude-3',
            ...
            -- Claude 3 Haiku
            ('anthropic', 'anthropic', 'claude-3-haiku-20240307', 'Claude 3 Haiku', 'claude-3',
        ...
        db.execute(text("""
            ...
            -- Gemini 2.5 Pro
            ('google', 'google', 'gemini-2.5-pro', 'Gemini 2.5 Pro', 'gemini-2.5',
            ...
            -- Gemini 2.5 Flash
            ('google', 'google', 'gemini-2.5-flash', 'Gemini 2.5 Flash', 'gemini-2.5',
            ...
            -- Gemini 1.5 Pro
            ('google', 'google', 'gemini-1.5-pro', 'Gemini 1.5 Pro', 'gemini-1.5',
        ...
        db.execute(text("""
            ...
            ('aws_bedrock', 'bedrock', 'anthropic.claude-3-5-sonnet-20241022-v2:0', 'Claude 3.5 Sonnet (Bedrock)', 'claude-3',
            ...
            ('aws_bedrock', 'bedrock', 'anthropic.claude-3-haiku-20240307-v1:0', 'Claude 3 Haiku (Bedrock)', 'claude-3',
             '{"speed": "fastest", "cost": "lowest", "reasoning": "good", "efficiency": "excellent"}',
            ...
            ('aws_bedrock', 'bedrock', 'meta.llama3-1-70b-instruct-v1:0', 'Llama 3.1 70B (Bedrock)', 'llama-3',
            ...
            ('aws_bedrock', 'bedrock', 'meta.llama3-1-8b-instruct-v1:0', 'Llama 3.1 8B (Bedrock)', 'llama-3',
        ...
        db.execute(text("""
            ...
            -- Mistral 7B Instruct
            ('huggingface', 'huggingface', 'mistralai/Mistral-7B-Instruct-v0.2', 'Mistral 7B Instruct', 'mistral',
            ...
            -- Llama 2 70B Chat
            ('huggingface', 'huggingface', 'meta-llama/Llama-2-70b-chat-hf', 'Llama 2 70B Chat', 'llama-2',
            ...
            -- Zephyr 7B Beta
            ('huggingface', 'huggingface', 'HuggingFaceH4/zephyr-7b-beta', 'Zephyr 7B Beta', 'mistral',
            ...
            ('huggingface', 'huggingface', 'KellanF89/Newton-Insights-V1-cannabis-extraction-science', 'Newton Insights V1', 'custom',
