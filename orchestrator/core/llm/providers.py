...
class ProviderSpec:
    ...
    # Passes Anthropic ``cache_control`` breakpoints through on an OpenAI-shaped
    # request (OpenRouter). The client then marks the stable system prefix and
    # asks for automatic caching of the conversation tail (2026-09-16).
...
_SPECS: Tuple[ProviderSpec, ...] = (
    ...
    ProviderSpec(
        ...
        web_search_tool="openrouter:web_search", prompt_cache_control=True,
    ),
    ProviderSpec(
