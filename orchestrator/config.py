...
class Config:
    ...
    COMPOSIO_SCHEMA_CACHE_LIMIT: int = int(os.getenv("COMPOSIO_SCHEMA_CACHE_LIMIT", "30"))
    COMPOSIO_SCHEMA_CACHE_MAX_LIMIT: int = int(os.getenv("COMPOSIO_SCHEMA_CACHE_MAX_LIMIT", "100"))
