...
from modules.memory.types.memory_types import (
    HierarchicalMemoryManager, MemoryItem, MemoryType, MemoryLevel
)
from modules.memory.operations.access_patterns import (
    MemoryAccessOptimizer, AccessPattern, AccessMetrics
)
from modules.memory.operations.augmentation import (
    VectorStoreAugmenter, AugmentationStrategy, AugmentedMemory
)
from modules.memory.operations.consolidation import (
