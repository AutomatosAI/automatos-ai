...
from ..types.memory_types import MemoryItem, MemoryType
...
class VectorStoreAugmenter:
    ...
    def __init__(
        ...
        self.model_name = model_name or config.EMBEDDING_MODEL or ""
    ...
    def _get_default_dimension(self) -> int:
        """Get embedding dimension from settings (not hardcoded)"""
        try:
    ...
    async def _rebuild_index(self):
        ...
        # Create new index
        if hasattr(self, 'index') and self.index and hasattr(self.index, 'nlist'):  # IVF index
