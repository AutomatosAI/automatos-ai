...
class EnhancedMCPBridge:
    ...
    def run(self, host: str = "0.0.0.0", port: int = 8001):
        ...
        # NOTE: routes should be registered in _setup_routes during initialization.
        # Any leftover inlined route definitions after server start were causing
        # syntax errors. Metrics routes already exist elsewhere in the API surface.
