...
from context_engineering.chunking import MultiModalChunker
from context_engineering.vector_store import PgVectorStore
from context_engineering.context_retriever import ContextRetriever, RetrievalConfig
from context_engineering.prompt_builder import ContextAwarePromptBuilder, PromptType
from context_engineering.learning_engine import AdaptiveLearningEngine
from context_engineering.agent_collaboration import create_collaboration_system
...
class ContextEngineeringManager:
    ...
    async def build_context_aware_prompt(self, task_description: str, 
        ...
        try:
            ...
            from context_engineering.context_retriever import ContextResult
            context_objects = []
