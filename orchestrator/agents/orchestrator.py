...
# Prefer context_engineering adapter; fallback to legacy EnhancedContextManager
try:
    from context_engineering import EnhancedContextManagerAdapter as EnhancedContextManager
except Exception:
