...
_SWEPT_ENV_VARS = (
    ...
    # PRD-251 Wave 1 S1.5 — speech from a voice toolkit, copied into storage.
    "SOCIALS_RENDER_MEDIA_URL_TTL_SECONDS",
    "SOCIALS_VOICE_LINE_MAX_BYTES",
    "SOCIALS_MEDIA_FETCH_TIMEOUT_SECONDS",
    "SOCIALS_VOICE_LIST_LIMIT",
)
...
_SOCIALS_DEFAULTS = {
    ...
    "SOCIALS_VOICE_LINE_MAX_BYTES": 16777216,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("SOCIALS_RENDER_MEDIA_URL_TTL_SECONDS", "7200", 7200),
        ("SOCIALS_VOICE_LINE_MAX_BYTES", "1048576", 1048576),
        ("SOCIALS_MEDIA_FETCH_TIMEOUT_SECONDS", "30", 30),
        ("SOCIALS_VOICE_LIST_LIMIT", "10", 10),
    ],
)
