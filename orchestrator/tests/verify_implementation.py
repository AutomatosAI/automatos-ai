...
def check_agent_list():
    ...
    try:
        # We can't easily authenticate in this script without a token, 
        # but a 401/403 is better than a 500.
        # However, the user's log showed 500.
        response = requests.get(f"{API_URL}/api/agents/")
        
        # If we get 500, it's failed.
