...
5. **Order of the Studio page waves (5a–5g).** Proposed by visibility, Agent Management first. Confirm or reorder.
6. **Default style for a new browser.** Classic + System until the Studio pass is signed. Whether it ever flips to Studio, and for whom, is yours.
