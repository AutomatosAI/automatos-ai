...
from context.chunking import MultiModalChunker
from context.vector_store import PgVectorStore
from context.context_retriever import ContextRetriever, RetrievalConfig
from context.prompt_builder import ContextAwarePromptBuilder, PromptType
from context.learning_engine import AdaptiveLearningEngine
from context.agent_collaboration import create_collaboration_system
...
class ContextEngineeringManager:
    ...
    async def build_context_aware_prompt(self, task_description: str, 
        ...
        try:
            ...
            from context.context_retriever import ContextResult
            context_objects = []
